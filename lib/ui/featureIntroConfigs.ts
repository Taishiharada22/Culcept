...
export const MY_STYLE_INTRO: FeatureIntroConfig = {
  ...
  introIcon: "◆",
  introDescription:
    "あなたのスタイルが形になっていく場所です。服を入れるたびに、輪郭が動き始めます。",
  introActions:
    "服の登録、天気連動コーデ、着用記録、スタイル軸の整理 — すべてが輪郭の形成につながります。",
  introBenefit:
    "「なぜこの服を選ぶのか」が見えてくる。スタイルの傾向と自分の深層が重なり始めます。",
  tabs: [
    {
      key: "today",
      icon: "☀️",
      ...
      title: "今日 — 毎日の形成",
      description:
        "天気に合わせた提案、着用記録、気分の観測。毎日の選択がスタイルの輪郭を鮮明にしていきます。",
    },
    {
      key: "wardrobe",
      icon: "👔",
      label: "クローゼット",
      title: "クローゼット — 持ち物と組み方",
      description:
        "ワードローブの管理、セットアップの作成、コスパ分析。持っている服から、あなたの傾向が浮かびます。",
    },
    {
      key: "styles",
      icon: "🪞",
      ...
      title: "わたし — 深層の輪郭",
      description:
        "スタイル軸の整理、アイデンティティの可視化、変化の記録。積み重ねたデータが、あなたの深層を映します。",
    },
  ],
  startingTab: "today",
};
