 ...
 *
 * - 東京都: 23特別区 + 主要市
 * - 政令指定都市を含む府県: 市レベル + 政令市の主要区
 * - その他の府県: 市のみ（町・村は除外）
 *
 * ベースラインフォームのチップ選択UIで、都道府県選択後に市区町村を選ぶために使用。
 */

/** 政令指定都市の一覧（20市） */
export const DESIGNATED_CITIES: string[] = [
  "札幌市",
  "仙台市",
  "さいたま市",
  "千葉市",
...
/** 都道府県 → 市区町村リスト */
export const PREFECTURE_MUNICIPALITIES: Record<string, string[]> = {
  北海道: [
    // 政令指定都市
    "札幌市",
    ...
    "芦別市", "江別市", "赤平市", "紋別市", "士別市", "名寄市", "三笠市",
    "根室市", "千歳市", "滝川市", "砂川市", "歌志内市", "深川市", "富良野市",
  ...
  埼玉県: [
    ...
    "さいたま市緑区", "さいたま市岩槻区",
    // 市
    "川越市", "熊谷市", "川口市", "行田市", "秩父市", "所沢市",
    "飯能市", "加須市", "本庄市", "東松山市", "春日部市", "狭山市",
    "羽生市", "鴻巣市", "深谷市", "上尾市", "草加市", "越谷市",
    "蕨市", "戸田市", "入間市", "朝霞市", "志木市", "和光市",
    "新座市", "桶川市", "久喜市", "北本市", "八潮市", "富士見市",
    "三郷市", "蓮田市", "坂戸市", "幸手市", "鶴ヶ島市", "日高市",
    "吉川市", "ふじみ野市", "白岡市",
  ],
  ...
  千葉県: [
    ...
    "千葉市緑区", "千葉市美浜区",
    // 市
    "銚子市", "市川市", "船橋市", "館山市", "木更津市", "松戸市",
    "野田市", "茂原市", "成田市", "佐倉市", "東金市", "旭市",
    "習志野市", "柏市", "勝浦市", "市原市", "流山市", "八千代市",
    "我孫子市", "鴨川市", "鎌ケ谷市", "君津市", "富津市", "浦安市",
    "四街道市", "袖ケ浦市", "八街市", "印西市", "白井市", "富里市",
  ...
  神奈川県: [
    ...
    "横浜市緑区", "横浜市瀬谷区", "横浜市栄区", "横浜市泉区", "横浜市青葉区",
    "横浜市都筑区",
    "川崎市",
  ...
  大阪府: [
    ...
    "堺市南区", "堺市北区", "堺市美原区",
    // 市
    "岸和田市", "豊中市", "池田市", "吹田市", "泉大津市", "高槻市",
    "貝塚市", "守口市", "枚方市", "茨木市", "八尾市", "泉佐野市",
    "富田林市", "寝屋川市", "河内長野市", "松原市", "大東市", "和泉市",
    "箕面市", "柏原市", "羽曳野市", "門真市", "摂津市", "高石市",
    "藤井寺市", "東大阪市", "泉南市", "四條畷市", "交野市", "大阪狭山市",
    "阪南市",
  ],
  ...
  福岡県: [
    ...
    "福岡市西区", "福岡市城南区", "福岡市早良区",
    // 市
    "大牟田市", "久留米市", "直方市", "飯塚市", "田川市", "柳川市",
    "八女市", "筑後市", "大川市", "行橋市", "豊前市", "中間市",
    "小郡市", "筑紫野市", "春日市", "大野城市", "宗像市", "太宰府市",
    "古賀市", "福津市", "うきは市", "宮若市", "嘉麻市", "朝倉市",
    "みやま市", "糸島市", "那珂川市",
  ],
