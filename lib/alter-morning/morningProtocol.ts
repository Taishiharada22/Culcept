...
const STRONG_TRIGGERS = [
  ...
  /今日は.*[、。]/,       // 「今日は〇〇と△△。」のような列挙
  /明日は.*[、。]/,       // 「明日は〇〇と△△。」のような列挙
  // CEO 2026-05-03: \s* 挿入で半角・全角空白許容 (= 「今日 14 時」「明日 8 時」 catch)
  /今日.*\d{1,2}\s*時/,     // 「今日14時に歯医者」 / 「今日 14 時に歯医者」
  /明日.*\d{1,2}\s*時/,     // 「明日14時に歯医者」 / 「明日 8 時東京駅から渋谷へ」
  ...
  /\d{1,2}\s*時に.{2,}/,             // 「14時に歯医者」 / 「14 時に歯医者」 — 今日なしでも時刻+予定 (CEO 2026-05-03 \s* 追加)
