...
/**
 * Stage 4 L4-b/B-1 — S4 理解更新中 のレイアウト (本番版)
 *
 * 正本: UI spec §5.7 / preview app/(dev)/coalter-preview/.../states/S4Understanding.tsx
 *
...
export interface S4UnderstandingProps {
  mode: PresenceMode;
