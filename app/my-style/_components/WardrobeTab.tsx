...
export default function WardrobeTab({ state, setState, showAddFormDefault }: WardrobeTabProps) {
    ...
    const removeItem = (id: string) => {
        setState((prev) => {
            ...
            return {
                ...prev,
                wardrobe,
                setups: prev.setups.map((s) => ({ ...s, items: s.items.filter((i) => i !== id) })),
                colorPrefs: computeColorPrefs(wardrobe),
            };
        });
    };
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        ...
                                        {inference.subcategories.slice(0, 3).map((x) => (
                                            <button
                                                key={`sub-${x}`}
                                                type="button"
                                                onClick={() => applyInferenceChip("subcategory", x)}
                                            ...
                                            >
                                                {optionLabel(subcategoryOptions, x) || x}
                                            </button>
                                        ))}
                                    </div>
                                )}
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        ...
                                        {inference.materials.slice(0, 3).map((x) => (
                                            <button
                                                key={`mat-${x}`}
                                                type="button"
                                                onClick={() => applyInferenceChip("material", x)}
                                                className="rounded-full border border-emerald-200 bg-white px-2.5 py-0.5 text-[10px] font-bold text-emerald-700 hover:bg-emerald-50 transition"
                                            >
                                                {optionLabel(MATERIAL_FAMILY_OPTIONS, x)}
                                            </button>
                                        ))}
                                    </div>
                                )}
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        ...
                                        {inference.surfaces.slice(0, 3).map((x) => (
                                            <button
                                                key={`sur-${x}`}
                                                type="button"
                                                onClick={() => applyInferenceChip("surface", x)}
                                                className="rounded-full border border-emerald-200 bg-white px-2.5 py-0.5 text-[10px] font-bold text-emerald-700 hover:bg-emerald-50 transition"
                                            >
                                                {optionLabel(SURFACE_FINISH_OPTIONS, x)}
                                            </button>
                                        ))}
                                    </div>
                                )}
