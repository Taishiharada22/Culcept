...
export const SUBCATEGORY_OPTIONS: Array<Option<string> & { categoryMain: CategoryMain }> = [
    ...
    { value: "subcategory.heal", label: "ヒール", categoryMain: "shoes" },
...
export function isFootwearCategory(main: CategoryMain) {
    return main === "shoes";
}

export const FOOTWEAR_UPPER_MATERIAL_OPTIONS: Option<string>[] = [
    { value: "fw_upper.smooth_leather", label: "スムースレザー" },
    { value: "fw_upper.suede", label: "スエード" },
    { value: "fw_upper.nubuck", label: "ヌバック" },
    { value: "fw_upper.patent", label: "エナメル" },
    { value: "fw_upper.canvas", label: "キャンバス" },
    { value: "fw_upper.knit", label: "ニット" },
    { value: "fw_upper.mesh", label: "メッシュ" },
    { value: "fw_upper.synthetic", label: "合成皮革" },
    { value: "fw_upper.rubber", label: "ラバー" },
    { value: "fw_upper.nylon", label: "ナイロン" },
];

export const FOOTWEAR_SOLE_TYPE_OPTIONS: Option<string>[] = [
    { value: "fw_sole.leather", label: "レザーソール" },
    { value: "fw_sole.rubber", label: "ラバーソール" },
    { value: "fw_sole.crepe", label: "クレープソール" },
    { value: "fw_sole.vibram", label: "ビブラムソール" },
    { value: "fw_sole.eva", label: "EVA" },
    { value: "fw_sole.gum", label: "ガムソール" },
];

export const FOOTWEAR_SURFACE_FINISH_OPTIONS: Option<string>[] = [
    { value: "fw_surface.matte", label: "マット" },
    { value: "fw_surface.polished", label: "ポリッシュ" },
    { value: "fw_surface.waxed", label: "ワックス仕上げ" },
    { value: "fw_surface.distressed", label: "ヴィンテージ加工" },
    { value: "fw_surface.glossy", label: "グロッシー" },
];

export const FOOTWEAR_CONSTRUCTION_OPTIONS: Option<string>[] = [
    { value: "fw_const.cemented", label: "セメンテッド" },
    { value: "fw_const.goodyear", label: "グッドイヤーウェルト" },
    { value: "fw_const.mckay", label: "マッケイ" },
    { value: "fw_const.stitch_down", label: "ステッチダウン" },
    { value: "fw_const.vulcanized", label: "バルカナイズ" },
    { value: "fw_const.injection", label: "インジェクション" },
];

export const FOOTWEAR_TOE_SHAPE_OPTIONS: Option<string>[] = [
    { value: "fw_toe.round", label: "ラウンドトゥ" },
    { value: "fw_toe.square", label: "スクエアトゥ" },
    { value: "fw_toe.pointed", label: "ポインテッドトゥ" },
    { value: "fw_toe.almond", label: "アーモンドトゥ" },
    { value: "fw_toe.plain", label: "プレーントゥ" },
    { value: "fw_toe.moc", label: "モックトゥ" },
    { value: "fw_toe.u_tip", label: "Uチップ" },
    { value: "fw_toe.wing", label: "ウィングチップ" },
];

export const FOOTWEAR_SILHOUETTE_OPTIONS: Option<string>[] = [
    { value: "fw_sil.low", label: "ローカット" },
    { value: "fw_sil.mid", label: "ミッドカット" },
    { value: "fw_sil.high", label: "ハイカット" },
    { value: "fw_sil.ankle", label: "アンクル" },
    { value: "fw_sil.chelsea", label: "サイドゴア" },
    { value: "fw_sil.loafer", label: "ローファー" },
    { value: "fw_sil.slip_on", label: "スリッポン" },
    { value: "fw_sil.mule", label: "ミュール" },
    { value: "fw_sil.sandal", label: "サンダル" },
];

export const FOOTWEAR_FIT_OPTIONS: Option<string>[] = [
    { value: "fw_fit.snug", label: "タイトフィット" },
    { value: "fw_fit.regular", label: "レギュラー" },
    { value: "fw_fit.relaxed", label: "リラックス" },
    { value: "fw_fit.wide", label: "ワイド" },
];

export const FOOTWEAR_HEEL_HEIGHT_OPTIONS: Option<string>[] = [
    { value: "fw_heel.flat", label: "フラット (0–2cm)" },
    { value: "fw_heel.low", label: "ロー (2–4cm)" },
    { value: "fw_heel.mid", label: "ミッド (4–7cm)" },
    { value: "fw_heel.high", label: "ハイ (7cm+)" },
];
