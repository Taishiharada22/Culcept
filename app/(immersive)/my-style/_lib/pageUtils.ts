...
/** Legacy tab IDs → new tab mapping (for URL compat) */
...
export const VALID_TABS: TabId[] = ["today", "closet", "me"];
...
export const TAB_CONFIG: Array<{
    ...
    { id: "closet", icon: "👔", label: "クローゼット", personality: "Closet", sub: "持ち物と組み方", accentColor: "#c96d4a", bgClass: "bg-gradient-to-b from-amber-50/50 via-orange-50/20 to-stone-50/30", cardBorder: "border-amber-200/40" },
    { id: "me", icon: "🪞", label: "わたし", personality: "Self", sub: "深層の輪郭", accentColor: "#0d9488", bgClass: "bg-gradient-to-b from-teal-50/40 via-emerald-50/20 to-stone-50/30", cardBorder: "border-teal-200/40" },
];
...
export function normalizeTabId(value: string | null): TabId | null {
    ...
    if (VALID_TABS.includes(value as TabId)) return value as TabId;
    // Legacy redirect
