    ...
    <div className="relative">
      ...
      <div className="relative h-[360px] flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            <span className="text-xs text-indigo-200/80 leading-tight block">
        ...
        >
          ...
          >
            ...
            <span className="text-xs text-amber-200/80 leading-tight block">
            ...
            >
              ...
              {isSubmitting && (
                ...
                >
                  ...
                  />
                  <span className="text-xs text-amber-200/40 tracking-[0.2em]">
                    RECORDING
                  </span>
                </motion.div>
              )}
      ...
      <div className="mt-3 px-8">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs text-amber-300/35 font-mono">
            {confidence}%
          </span>
        </div>
        <div className="relative">
      ...
      <div className="text-center mt-4">
        <button
          ...
          className="text-xs text-white/12 hover:text-white/25 transition-colors disabled:opacity-30 py-2 px-4"
        >
          この質問をスキップ
        </button>
      </div>
