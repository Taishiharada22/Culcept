...
import DropMatchScorePanel from "./DropMatchScorePanel";
...
export async function generateMetadata({
    ...
    const desc = String(drop.description ?? "").slice(0, 160) || "View this product on Aneurasync.";
...
export default async function DropDetailPage({
    ...
    return (
        <div className="grid gap-4">
            ...
            <DropMatchScorePanel itemId={d.id} />
