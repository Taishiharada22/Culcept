...
export default function ConciergeDashboard({ trip, day, onNavigate, onClose, onOpenMap, onToast }: TravelScreenProps) {
  ...
  const featuredMeal = day.meal?.alternatives[0] ?? null; // E-2: meal 未提供（DB 経路）なら null
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <ConciergeCard className="flex flex-col p-3">
            ...
            {day.budget ? (
              ...
              // E-2 honest optional: budget 未提供（DB 経路）は捏造せず空表示
              <p className="text-[9px]" style={{ color: T.ink3 }}>予算データ未登録</p>
            )}
