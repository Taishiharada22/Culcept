...
const NECK_PCT = 13.4; // 頭部の水の下端 = 顎の高さ（B19・CEO 微調整: 12.8→13.6）
...
const CHIN_MASK =
  "linear-gradient(to bottom, #000 76%, transparent 60%), radial-gradient(8.7% 20% at 50.5% 77%, #000 99%, transparent 100%)";
const BODY_TOP_PCT = 20; // 肩（体ゾーンの上端）
