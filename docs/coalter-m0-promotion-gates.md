...
**着手条件 (all-of)** — 詳細は [coalter-m0-6b-prerequisites.md](./coalter-m0-6b-prerequisites.md) に正式定義:
1. M0-6A 完了
...
**証拠物の形**: prerequisites 文書 §3 に 3 前提それぞれの必須証拠物を明記。
**判定チェックリスト**: prerequisites 文書 §4 を all-of で充足 + CEO 明示承認が必要。
