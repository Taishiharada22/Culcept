...
### Week 2: anchor-first 再構築 + Deep Context Injection
目的: **順序崩壊ゼロ + 自分のことを分かってる感**

#### anchor-first deterministic planner
...
- W1: 壊れた確定プランが出なくなり、保守メッセージが率直に出ている
- W2: LLM `order` が使われない / Stargazer 軸が PlanningContext に入っている
