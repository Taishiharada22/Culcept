...
| **RC2a** | **RG0.6 §12 で再定義**（`docs/reality-graph-contract-hardening-rg06.md`）: RealityInstant 時刻契約 + MovementReality v0 + commitmentSignal + deriveMomentSnapshot（decisionDebt **成分**v0）+ RealityGraphSnapshot assembler | MomentStateSnapshot / MovementReality / Graph root | RG0.6 確認後の GO |
